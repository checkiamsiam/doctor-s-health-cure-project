      ...
      <div className="hero min-h-screen bg-transparent">
        <div className="hero-content flex-col lg:flex-row-reverse lg:gap-20">
          ...
          <div className='lg:w-1/2'>
            <h1 className="md:text-5xl text-2xl font-bold text-neutral">Is Teeth Whitening Safe For My Enamel?</h1>
            <p className="py-6 text-neutral  font-mono "> The yellow discoloration of your teeth is the most common sign of damaged enamel. This begs the question “does teeth whitening damage the enamel?” The answer is no, teeth whitening doesn't damage your tooth enamel.</p>
