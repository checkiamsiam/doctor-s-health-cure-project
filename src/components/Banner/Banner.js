    ...
    <div className="container mx-auto mb-3 md:p-0 p-5 pt-0 bg-forBanner bg-cover bg-center">
      <Slider {...settings}>
        <div>
          <div className="hero bg-transparent  md:min-h-screen">
            <div className="hero-content flex-col lg:flex-row lg:gap-40">
              <img src={Modern} alt='machinePhoto' className="max-w-sm w-full rounded-lg shadow-2xl " />
        ...
        <div>
          <div className="hero bg-transparent md:min-h-screen">
            <div className="hero-content flex-col lg:flex-row lg:gap-40">
              <img src={baby} alt='babyCare' className="max-w-sm  w-full rounded-lg shadow-2xl " />
              <div className='lg:w-1/2'>
        ...
        <div>
          <div className="hero bg-transparent md:min-h-screen">
            <div className="hero-content flex-col lg:flex-row lg:gap-40">
              <img src={chair} alt="Medical Chair" className="max-w-sm w-full rounded-lg shadow-2xl " />
              <div className='lg:w-1/2'>
